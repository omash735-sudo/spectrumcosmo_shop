    ...
    <>
      ...
      <main className="min-h-screen bg-[var(--background)]">
        ...
        {/* ============================================
            ...
            ============================================ */}
        <div className="bg-[#111111] min-h-[70vh] flex items-center py-16 lg:py-20 border-t border-[var(--border)]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="text-center">
              ...
              <p className="text-base md:text-lg text-[#9A9A9A] max-w-xl mx-auto mb-6">
              ...
              {/* Status Indicator */}
              {subscribed && (
                <div className="mt-4 flex items-center justify-center gap-2 bg-green-500/10 text-green-400 py-1.5 px-4 rounded-full max-w-xs mx-auto">
                  <CheckCircle size={16} />
                  <span className="text-sm font-medium">You're subscribed! ✓</span>
                </div>
              )}

              <p className="text-[#9A9A9A] text-xs mt-4">No spam. Unsubscribe anytime.</p>
              
              {/* Preferences Link */}
              <div className="mt-6">
                <Link 
                  href="/newsletter/preferences" 
                  className="text-sm text-[#9A9A9A] hover:text-[var(--primary)] transition inline-flex items-center gap-1"
                >
