          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-md w-full shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="p-6 border-b dark:border-gray-800">
              <div className="flex justify-between items-center">
                ...
                <button onClick={() => setShowThemeModal(false)} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition">
            ...
            <div className="p-6 space-y-3">
              ...
              >
                ...
                {theme === 'light' && <div className="w-2 h-2 rounded-full bg-orange-500"></div>}
              </button>
              ...
              >
                ...
                {theme === 'system' && <div className="w-2 h-2 rounded-full bg-orange-500"></div>}
              </button>
            </div>

            <div className="p-6 border-t dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 rounded-b-2xl">
              <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                Your preference is saved automatically and syncs across devices
              </p>
            </div>
          </div>
        </div>
