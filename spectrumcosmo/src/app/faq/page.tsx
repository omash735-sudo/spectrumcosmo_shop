        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-orange-100 px-3 py-1 rounded-full mb-4">
              ...
              <span className="text-xs font-medium text-orange-600">Help Center</span>
            </div>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Frequently Asked Questions</h1>
            <p className="text-gray-500 mt-2 max-w-xl mx-auto">Find answers to common questions about ordering, payments, and delivery.</p>
          </div>
          ...
          <div className="relative max-w-xl mx-auto mb-8">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition shadow-sm"
            />
          </div>
          ...
          {!showAskForm && (
            <div className="text-center mb-8">
              <button
                ...
                className="inline-flex items-center gap-2 text-orange-600 hover:text-orange-700 font-medium bg-orange-50 px-5 py-2.5 rounded-full transition-all hover:bg-orange-100"
              >
                <Plus size={18} />
              ...
              <div className="bg-white rounded-2xl max-w-lg w-full shadow-xl" onClick={(e) => e.stopPropagation()}>
                <div className="p-6 border-b">
                  <div className="flex justify-between items-center">
                    ...
                    <button onClick={() => setShowAskForm(false)} className="p-1 hover:bg-gray-100 rounded-lg transition">
                      <X size={20} />
                    </button>
                  </div>
                  <p className="text-sm text-gray-500 mt-1">We'll answer your question as soon as possible</p>
                </div>
                <form onSubmit={handleSubmitQuestion} className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-200 rounded-xl p-2.5 text-sm focus:ring-2 focus:ring-orange-500"
                  ...
                  {submitMessage && (
                    <div className={`p-3 rounded-xl text-sm flex items-center gap-2 ${submitMessage.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}>
          ...
          <div className="mt-12 bg-gradient-to-r from-gray-50 to-white rounded-2xl p-6 text-center border border-gray-100">
            <h3 className="font-semibold text-gray-800 mb-2">Still need help?</h3>
            <p className="text-sm text-gray-500 mb-4">Contact our support team for personalized assistance</p>
