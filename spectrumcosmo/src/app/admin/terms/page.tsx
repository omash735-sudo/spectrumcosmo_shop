...
import { Loader2, Save, AlertCircle, Eye, FileText } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[var(--background)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[var(--foreground-muted)]">Loading terms content...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-orange-50 dark:bg-orange-950/30 flex items-center justify-center">
                <FileText className="w-4 h-4 sm:w-5 sm:h-5 text-[var(--primary)]" />
              </div>
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-[var(--foreground)]">Terms & Conditions</h1>
                <p className="text-xs sm:text-sm text-[var(--foreground-muted)] mt-0.5">
                  Manage your store's legal terms and conditions
                </p>
              </div>
            </div>
            <button
        ...
        <div className="bg-[var(--background-card)] rounded-xl border border-[var(--border)] shadow-sm overflow-hidden">
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
            {preview ? (
              ...
              <div className="prose dark:prose-invert max-w-none">
                <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-lg p-3 sm:p-4 mb-4">
                  <p className="text-xs sm:text-sm text-orange-700 dark:text-orange-400 flex items-center gap-2">
                    <AlertCircle className="w-4 h-4" />
                    This is a preview of how your terms will appear on the frontend.
                  </p>
                </div>
                <h1 className="text-2xl sm:text-3xl font-bold text-[var(--foreground)]">{content.title || 'Terms & Conditions'}</h1>
              ...
              <>
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--foreground-muted)] mt-1 opacity-70">
                    This date will be displayed on the frontend terms page.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="<p>Write your terms and conditions here...</p>"
                  />
          ...
          <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-[var(--border)] bg-[var(--background-secondary)] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-xs text-[var(--foreground-muted)]">
              ...
              <span>Changes will appear on the frontend terms page immediately after saving.</span>
            </div>
            <button
              onClick={save}
              disabled={saving}
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-xs sm:text-sm text-orange-700 dark:text-orange-400">
                <strong>Pro Tip:</strong> Use the <strong>Preview</strong> toggle to see how your terms will look on the frontend before saving. 
                You can use HTML tags like <code className="bg-orange-100 dark:bg-orange-900/50 px-1.5 py-0.5 rounded text-[10px]">&lt;h2&gt;</code>, 
                <code className="bg-orange-100 dark:bg-orange-900/50 px-1.5 py-0.5 rounded text-[10px]">&lt;ul&gt;</code>, and 
                <code className="bg-orange-100 dark:bg-orange-900/50 px-1.5 py-0.5 rounded text-[10px]">&lt;strong&gt;</code> to format your content.
              </p>
            </div>
          </div>
        </div>
