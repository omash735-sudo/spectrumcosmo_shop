...
export default function AdminOrderDetailPage() {
  ...
  if (!order) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-400 dark:text-gray-500 text-sm mt-2">This order may have been deleted</p>
        <Link href="/admin/orders" className="inline-block mt-4 text-orange-500 hover:text-orange-600">
          Back to orders
        </Link>
      </div>
    );
  ...
  return (
    <div className="pt-16 lg:pt-0 px-4 max-w-7xl mx-auto pb-12">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <Printer size={18} className="text-gray-500 dark:text-gray-400" />
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-4">
          ...
          <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full ${paymentInfo.bg} ${paymentInfo.color}`}>
            <PaymentIcon size={14} />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{order.customer_email || 'N/A'}</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-300">{order.phone_number}</p>
                  <button
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">{order.delivery_address}</p>
              </div>
            </div>
          </div>
              ...
              {order.items && order.items.length > 0 ? (
                order.items.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap ml-4">
                      {formatCurrency(item.quantity * item.unit_price_usd)}
                    </p>
                  </div>
                ))
              ) : (
                <p className="text-sm text-gray-400 dark:text-gray-500 text-center py-4">No items found</p>
              )}
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 space-y-2">
              ...
              {order.promo_code && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-orange-500 font-medium">{order.promo_code}</span>
                </div>
              )}
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={updating}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition text-sm font-medium disabled:opacity-50"
                  >
            ...
            <div className="space-y-3 text-sm">
              ...
              {order.payment_note && (
                <div className="mt-2 pt-2 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300">{order.payment_note}</p>
                </div>
              )}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
            ...
            {editingNotes ? (
              ...
              <div>
                {order.admin_notes ? (
                  <p className="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{order.admin_notes}</p>
                ) : (
                  <p className="text-sm text-gray-400 dark:text-gray-500 italic">No admin notes</p>
                )}
                <button
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-gray-900 dark:text-white font-mono text-xs">{order.id}</span>
              </div>
              <div className="flex justify-between">
              ...
              {order.tracking_number && (
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 dark:text-white font-medium">{order.tracking_number}</span>
                </div>
              )}
              {order.tracking_notes && (
                <div className="pt-2 border-t border-gray-100 dark:border-gray-700">
                  <span className="text-gray-500 dark:text-gray-400 text-xs">Tracking Notes</span>
                  <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">{order.tracking_notes}</p>
                </div>
              )}
            </div>
          </div>
