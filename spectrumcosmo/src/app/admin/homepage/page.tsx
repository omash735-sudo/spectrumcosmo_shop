    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Homepage Editor</h1>
          <p className="text-sm sm:text-base text-gray-500 mt-1">Manage categories, featured products, popups, and customer features</p>
        </div>
            ...
            <div className="p-4 sm:p-6">
              {categories.length === 0 ? (
                ...
                <div className="space-y-3">
                  {categories.map(cat => (
                    <div key={cat.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-sm transition gap-3">
                      ...
                      <div className="flex gap-1 w-full sm:w-auto justify-end">
                        ...
                        <button 
                          ...
                          className="p-2 hover:bg-red-100 rounded-md text-red-500 transition"
                          title="Delete"
                        >
                          <Trash2 size={16} />
                        </button>
        ...
        {activeTab === 'products' && (
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="px-4 sm:px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-lg">
              ...
              <p className="text-sm text-gray-500 mt-1">Toggle which products appear in the featured section on your homepage</p>
            </div>
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {products.map(p => (
                  <div key={p.id} className="flex items-center gap-3 p-3 border border-gray-200 rounded-md hover:shadow-sm transition">
              ...
              <div className="border-b border-gray-200 pb-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-3">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-10 h-5 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-orange-200 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-orange-500"></div>
                  </label>
                </div>
                
                {features.recentlyViewed.enabled && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 ml-0 sm:ml-6 pl-0 sm:pl-4 border-l-0 sm:border-l-2 border-gray-200">
                    <div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="px-4 sm:px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-lg">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Popup Modal</h2>
              </div>
              <p className="text-sm text-gray-500 mt-1">Configure the announcement popup that appears to visitors</p>
            </div>
            <div className="p-4 sm:p-6">
              <div className="space-y-5 max-w-2xl">
                <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-md">
                  <input 
                    type="checkbox" 
                  ...
                  />
                  <span className="text-sm text-gray-700">Enable popup on homepage</span>
                </label>
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-start">
                    {popup.image_url && (
                      <div className="relative w-24 h-24 rounded-md overflow-hidden bg-gray-100 border flex-shrink-0">
                    ...
                    <label className="cursor-pointer">
                      <div className="border-2 border-dashed border-gray-300 rounded-md p-4 text-center hover:border-orange-500 hover:bg-orange-50 transition">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-400 mt-1">Delay before popup appears</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Don&apos;t show for (days)</label>
                    <select
