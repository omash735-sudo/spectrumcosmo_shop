  ...
  try {
    ...
    if (!tableCheck[0]?.exists) {
      ...
      return NextResponse.json([
        ...
        { id: 4, rule_key: 'checkout_protection', rule_name: 'Checkout Protection', description: 'Limits checkout attempts per IP', is_enabled: true, config: { max_attempts: 10, window_hours: 1 } },
