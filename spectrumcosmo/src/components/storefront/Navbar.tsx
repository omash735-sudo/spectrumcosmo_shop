            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="relative p-2 rounded-lg hover:bg-orange-50 text-gray-700"
                >
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="w-full text-left block px-4 py-2.5 text-sm font-medium text-gray-700 hover:text-[#F97316] hover:bg-orange-50 rounded-lg"
              >
                Cart ({totalItems})
              </button>
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="w-7 h-7 rounded border grid place-items-center"
                        >
                          <Minus size={14} />
                        </button>
