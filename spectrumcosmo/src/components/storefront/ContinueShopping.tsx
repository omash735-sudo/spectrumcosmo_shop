...
export default function ContinueShopping() {
  ...
  return (
    <div className="fixed bottom-24 left-4 right-4 sm:left-auto sm:right-6 sm:bottom-24 z-40 md:left-auto">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-3 flex items-center justify-between gap-3 animate-in slide-in-from-bottom-5 duration-300">
        <div className="flex items-center gap-2">
          <div className="bg-orange-100 p-2 rounded-full">
            <ShoppingBag size={16} className="text-[#F97316]" />
          </div>
          <div className="text-sm">
            <p className="font-medium text-gray-800">Continue Shopping</p>
            <p className="text-xs text-gray-500">in {lastCategory}</p>
          </div>
        </div>
